...
/**
 * @todo process - organize people by div and dept
 * @todo process - department list
 * @todo process - managers list
 * @todo process - managers with flat downlines
 * @todo process - managers with hierarchical downlines
 * @todo return - all data above
 *
 */
...
module.exports = {
	...
	ProcessAllPeopleFlat: (event, context) =>
		// return a new promise
		new Promise((resolve, reject) => {
